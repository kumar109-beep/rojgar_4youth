...
# Custome Import
from ..serializers.aboutUsSerializers import *


@api_view(['GET', 'POST'])
@parser_classes([MultiPartParser, FormParser, JSONParser])
@permission_classes([IsAuthenticated])
def aboutUs_list(request, format=None):
    if request.method == 'POST':
        serializer = AboutsUsSerializer(data=request.data)
        ...
        serializer = AboutsUsSerializer(snippets, many=True)
